$(document).ready(function () {
    ...
    $("#id_il").change(function () {
        const url = $("#updateForm").attr("data-counties-url");  // get the url of the `load_cities` view
    ...
    $("#id_ilce").change(function () {
        const url = $("#updateForm").attr("data-neighbourhoods-url");  // get the url of the `load_cities` view
